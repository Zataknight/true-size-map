...
export class Backend implements backendInterface {
    ...
    async deleteFavorite(arg0: string): Promise<boolean> {
    ...
    async getFavorites(): Promise<Array<FavoriteComparison>> {
        if (this.processError) {
            try {
    ...
    async saveFavorite(arg0: string, arg1: Array<string>, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.saveFavorite(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
